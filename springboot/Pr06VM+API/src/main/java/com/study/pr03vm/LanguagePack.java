...
class KoreanPack {
    ...
    static {
        ...
        dictionary.put("상품이 추가되었습니다.", "상품이 추가되었습니다.");
        dictionary.put("상품이 수정되었습니다.", "상품이 수정되었습니다.");
        dictionary.put("상품이 삭제되었습니다.", "상품이 삭제되었습니다.");
        dictionary.put("오류가 발생했습니다.", "오류가 발생했습니다.");
    }
}
...
final class EnglishPack {
    ...
    static {
        ...
        dictionary.put("상품이 추가되었습니다.", "Product was added.");
        dictionary.put("상품이 수정되었습니다.", "Product was edited.");
        dictionary.put("상품이 삭제되었습니다.", "Product was removed.");
        dictionary.put("오류가 발생했습니다.", "Error occurred.");
    }
}
